    ...
    <div class="main-container" style="display:flex; align-items: center; flex-direction: column;">
        ...
        <form class="row g-3" method="post" action="/BenhNhanServlet" style="width:50%" >
            ...
            <div class="col-md-6">
                ...
                <input type="text" name ="maBenhAn" class="form-control disabled" id="inputEmail4" placeholder="ma benh an"  >
            </div>
            <div class="col-md-6">
                <label for="inputPassword4" class="form-label">Mã bệnh nhân</label>
                <input type="text" name ="maBenhNhan"class="form-control" id="inputPassword4" placeholder="ma benh nhan">
            </div>
            <div class="col-12">
                <label for="inputBirthDate" class="form-label">Ten Benh nhan</label>
                <input type="text" name ="tenBenhNhan"class="form-control" id="inputBirthDate" placeholder="Ten benh nhan">
            </div>
            <div class="col-12">
                <label for="inputDate1" class="form-label">Ngày nhập viện</label>
                <input type="date" name ="ngayNhapVien"class="form-control" id="inputDate1" placeholder="ngay nhap vien">
            </div>
            <div class="col-12">
                <label for="inputAddress" class="form-label">Ngày ra viện</label>
                <input type="date" name="ngayRaVien" class="form-control" id="inputAddress" placeholder="ngay ra vien">
            </div>
            <div class="col-12">
                <label for="input1" class="form-label">Lí do</label>
                <input type="text" name="liDo" class="form-control" id="input1" placeholder="Li do">
            </div>
