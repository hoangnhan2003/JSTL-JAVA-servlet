...
<div class="container-full">
  ...
  <div class="main-container">
    <div class="list-link" style="margin-bottom:20px ; margin-left: 10px;">
      <a class="btn  btn-success" href="/StudentServlet?action='' role="button">Display all student </a>
      <a class="btn btn-info" href="#" role="button">Do some thing</a>

    </div>
    <table class="table table-striped" style="margin-top:20px;" >
      <thead>
        <h3 style="text-align: center">student results ${student.studentName}</h3>
      ...
      <c:forEach items="${resultList}" var="result">
        <tr>
          ...
          <td>${result.result}</td>
          <td> <c:choose>
            <c:when test = "${result.result >= 3.6 }">
              Xuất sắc
            </c:when>
            <c:when test = "${result.result >= 3.2 }">
              Giỏi
            </c:when>
            <c:when test = "${result.result >= 2.5 }">
              Khá
            </c:when>
          ...
          <td><a type="button" class="btn btn-info" href="/StudentServlet?action=edit&studentId=${student.studentId}&semester=${result.semester}">Edit</a></td>
