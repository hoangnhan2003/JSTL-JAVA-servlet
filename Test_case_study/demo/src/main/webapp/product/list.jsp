...
<div class="container-full">
    ...
    <div class="main-container">
        <div class="list-link" style="margin-bottom:20px ; margin-left: 10px;">
            <a class="btn  btn-success" href="/ProductServlet?action=create" role="button">Add new product</a>
...
<script>
    ...
    exampleModal.addEventListener('show.bs.modal', event => {
        ...
        document.getElementById('deleteButton').href = "/ProductServlet?action=delete&productName=" +productName;
    })
</script>
</body>
</html>
